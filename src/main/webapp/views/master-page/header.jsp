...
<div>
	<img src="images/logoNuevo.png" alt="Acme Shout Co., Inc." />
</div>
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="administrator/chart.do"><spring:message code="master.page.administrator.chart" /></a></li>					
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="hasRole('CUSTOMER')">
			<li><a class="fNiv"><spring:message	code="master.page.customer" /></a>
				<ul>
					...
					<li><a href="customer/enterashout.do"><spring:message code="master.page.customer.action.2" /></a></li>				
				</ul>
			</li>
		</security:authorize>
